...
const tyrannosaurus = new Dinosaurs({
  name: 'tyrannosaurus',
  diet: 'carnivorous',
  weight: '7000kg',
  length: '12m',
...
const stegosaurus = new Dinosaurs({
  name: 'stegosaurus',
  diet: 'herbivorous',
  weight: '2000kg',
  length: '9m',
...
const velociraptor = new Dinosaurs({
  name: 'velociraptor',
  diet: 'carnivorous',
  weight: '15kg',
  length:' 1.8m',
...
graduates.forEach((graduates) => {
  ...
  return universities.push(`${university}`);
})
...
graduates.forEach((graduates) => {
  let firstName = graduates.first_name;
  let email = graduates.email;
  return contactInfo.push(`${firstName} ${email}`);
})
...
zooAnimals.forEach((zooAnimals) => {
  let animalName = zooAnimals.animal_name;
  let scientificName = zooAnimals.scientific_name;
  return animalNames.push(`Name: ${animalName}  Scientific: ${scientificName}`);
})
